...
<div class="content">
                ...
                <form action="doctor_insert.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="hospital_id" class="form-control" placeholder="Enter Hospital">
                        </div>
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Edit Doctors Data </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <form action="doctor_update.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="update_doctor_id" id="update_doctor_id">
                        ...
                        <div class="form-group">
                             <label> Hospital </label>
                            <input type="text" name="hospital_id" id="hospital_id" class="form-control"
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Delete Doctors Data </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#update_doctor_id').val(data[0]);
                $('#name').val(data[1]);
                $('#contact').val(data[2]);
                $('#email').val(data[3]);
                $('#hospital_id').val(data[4]);
