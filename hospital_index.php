    ...
    <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="hospital_insert.php" method="POST">
            ...
            <div class="modal-content">
                ...
                <form action="hospital_update.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="update_hospital_id" id="update_hospital_id">
            ...
            <div class="modal-content">
                ...
                <form action="hospital_delete.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="delete_hospital_id" id="delete_hospital_id">
